...
public class MaintenanceRequestRepository implements PanacheRepository<MaintenanceRequest> {
    ...
    public MaintenanceRequest findByIdAndOwnerId(Long id, String ownerId) {
    ...
    public List<MaintenanceRequest> findMaintenanceRequests(String ownerId, int page, int pageSize) {
